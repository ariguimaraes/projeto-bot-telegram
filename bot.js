...
bot.on('text', async (ctx) => {
    ...
    if (currentHour >= 9 && currentHour < 19) {
        await ctx.reply('O horário de funcionamento da empresa é das 09:00 às 19:00. Por favor, visite o link: https://faesa.br');
    } else {
        await ctx.reply('O horário de funcionamento da empresa é das 09:00 às 19:00. Por favor, deixe seu e-mail para que possamos entrar em contato.');
